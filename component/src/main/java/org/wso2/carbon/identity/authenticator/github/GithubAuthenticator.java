...
public class GithubAuthenticator extends OpenIDConnectAuthenticator implements FederatedApplicationAuthenticator {
    ...
    protected void processAuthenticationResponse(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (LoggerUtils.isDiagnosticLogsEnabled() && diagnosticLogBuilder != null) {
                diagnosticLogBuilder.resultMessage("Successfully authenticated with the github user account.")
                        .resultStatus(DiagnosticLog.ResultStatus.SUCCESS);
                if (context.getSubject().getUserAttributes() != null) {
                    Set<Map.Entry<ClaimMapping, String>> userAttributes = context.getSubject().getUserAttributes()
                            .entrySet();
